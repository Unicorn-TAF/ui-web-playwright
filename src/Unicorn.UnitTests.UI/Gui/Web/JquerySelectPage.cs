...
namespace Unicorn.UnitTests.UI.Gui.Web
{
    ...
    public class JquerySelectPage : WebPage
    {
        ...
        [DefineDropdown(DropdownElement.ExpandCollapse, Using.WebCss, ":scope")]
        [DefineDropdown(DropdownElement.OptionsFrame, Using.WebXpath, "ancestor::body//div[contains(@class, 'ui-selectmenu-open')]")]
        [DefineDropdown(DropdownElement.Option, Using.WebXpath, "ancestor::body//div[contains(@class, 'ui-selectmenu-open')]//div[@role = 'option']")]
