    ...
    public class UiMatchersWeb : WebTestsBase
    {
        ...
        public void TestWindowHasTitleMatcherMatcherNegative()
        {
            ...
            AssertThrows<AssertionException>(() =>
                Assert.That(dialogPage.Dialog, Ui.Window.HasTitle("weeee")));
        }
        ...
        public void TestModalWindowHasTextMatcherNegative()
        {
            ...
            AssertThrows<AssertionException>(() =>
                Assert.That(dialogPage.Dialog, Ui.Window.HasText("weee")));
        }
        ...
        public void TestDataGridHasRowsCountMatcherNegative()
        {
            ...
            AssertThrows<AssertionException>(() => 
                Assert.That(gridPage.DataGrid, Ui.DataGrid.HasRowsCount(10)));
        }
        ...
        public void TestDataGridHasRowMatcherNegative()
        {
            ...
            AssertThrows<AssertionException>(() =>
                Assert.That(gridPage.DataGrid, Ui.DataGrid.HasRow("Continent", "weee")));
        }
        ...
        public void TestDataGridHasColumnMatcherNegative()
        {
            ...
            AssertThrows<AssertionException>(() =>
                Assert.That(gridPage.DataGrid, Ui.DataGrid.HasColumn("weee")));
        }
        ...
        public void TestDataGridHasCellWithTextMatcher1Negative()
        {
            ...
            AssertThrows<AssertionException>(() =>
                Assert.That(gridPage.DataGrid, Ui.DataGrid.HasCellWithText("Continent", "Europe", "Name", "weee")));
        }
        ...
        public void TestDataGridHasCellWithTextMatcher2Negative()
        {
            ...
            AssertThrows<AssertionException>(() =>
                Assert.That(gridPage.DataGrid, Ui.DataGrid.HasCellWithText(0, 1, "weee")));
        }
        ...
        public void TestDropdownHasSelectedValueMatcherNegative()
        {
            ...
            AssertThrows<AssertionException>(() => 
                Assert.That(selectPage.Dropdown, Ui.Dropdown.HasSelectedValue("weee")));
        }
        ...
        public void TestCheckboxCheckedMatcherNegative()
        {
            ...
            AssertThrows<AssertionException>(() => 
                Assert.That(cboxPage.JqCheckbox, Ui.Checkbox.Checked()));
        }
        ...
        public void TestCheckboxHasCheckStateMatcherNegative()
        {
            ...
            AssertThrows<AssertionException>(() =>
                Assert.That(cboxPage.JqCheckboxToCheck2, Ui.Checkbox.HasCheckState(false)));
        }
        ...
        public void TestSelectedMatcherNegative()
        {
            ...
            AssertThrows<AssertionException>(() =>
                Assert.That(cboxPage.JqRadio, Ui.Control.Selected()));
        }
    }
}
