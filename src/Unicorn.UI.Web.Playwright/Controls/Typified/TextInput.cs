...
namespace Unicorn.UI.Web.Controls.Typified
{
    ...
    public class TextInput : WebControl, ITextInput
    {
        ...
        /// </summary>
        public virtual string Value => Instance.InputValueAsync().GetAwaiter().GetResult();
        ...
        public virtual void SendKeys(string text)
        {
            ...
            Instance.PressSequentiallyAsync(text).GetAwaiter().GetResult();
        }
        ...
        public virtual bool SetValue(string text)
        {
            ...
            {
                Instance.ClearAsync().GetAwaiter().GetResult();
                Instance.FillAsync(text).GetAwaiter().GetResult();
                return true;
            }
            else
            {
