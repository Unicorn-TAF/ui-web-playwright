...
namespace Unicorn.UI.Web.Controls.Typified
{
    ...
    public class Checkbox : WebControl, ICheckbox
    {
        ...
        /// </summary>
        public virtual bool Checked => Instance.IsCheckedAsync().GetAwaiter().GetResult();
        ...
        public bool Check()
        {
            ...
            Instance.CheckAsync().GetAwaiter().GetResult();
        ...
        public bool Uncheck()
        {
            ...
            Instance.UncheckAsync().GetAwaiter().GetResult();
